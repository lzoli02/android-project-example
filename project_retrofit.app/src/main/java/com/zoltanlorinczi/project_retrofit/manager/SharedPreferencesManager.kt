...
class SharedPreferencesManager(context: Context) {
    ...
    companion object {
        ...
        private const val SHARED_PREFERENCES_NAME = "MarketPlaceSharedPreferences"
    }

    private var preferences: SharedPreferences = context.getSharedPreferences(SHARED_PREFERENCES_NAME, Context.MODE_PRIVATE)

    fun putStringValue(key: String, value: String) = preferences.edit().putString(key, value).apply()

    fun getStringValue(key: String, defaultValue: String): String? = preferences.getString(key, defaultValue)
